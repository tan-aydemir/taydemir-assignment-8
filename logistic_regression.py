...
def do_experiments(start, end, step_num):
    ...
    plt.subplot(3, 3, 1)
    plt.plot(shift_distances, beta0_list, marker='o', linestyle='-', color='b')
    ...
    plt.subplot(3, 3, 2)
    plt.plot(shift_distances, beta1_list, marker='o', linestyle='-', color="b")
    ...
    plt.subplot(3, 3, 3)
    plt.plot(shift_distances, beta2_list, marker='o', linestyle='-', color='b')
    ...
    plt.subplot(3, 3, 4)
    plt.plot(shift_distances, slope_list, marker='o', linestyle='-', color='b')
    ...
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, intercept_list, marker='o', linestyle='-', color='b')
    ...
    # Plot logistic loss
    plt.subplot(3, 3, 6)
    plt.plot(shift_distances, loss_list, marker='o', linestyle='-', color='b')
    ...
    plt.subplot(3, 3, 7)
    plt.plot(shift_distances, margin_widths, marker='o', linestyle='-', color='b')
